...
class Ticket(models.Model):
    ...
    staff_comment = models.TextField(verbose_name="Commentaire staff au client (envoyé par email)", blank=True, null=True)
    staff_comment_perm = models.TextField(verbose_name="Commentaire au permanencier", blank=True, null=True)
